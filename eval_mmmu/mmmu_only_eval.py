...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path', type=str, default="mmmu_eval_output.json",
    ...
    for category in CAT_SHORT2LONG.values():
        ...
        for data_id, parsed_pred in cat_outputs.items():
            ...
            if question_type != 'multiple-choice':
                ...
                # print(parsed_pred)
                # print(cat_answers[data_id]['ground_truth'])
                correct = eval_open(cat_answers[data_id]['ground_truth'], parsed_pred)
            else:
